...
UI_TEXT = {
    "English": {
        ...
        "geo_labels": ["[ GLOBAL ]", "[ MKD ]", "[ KOS ]", "[ ALB ]", "[ BALKANS ]", "[ INT ]"],
    ...
    "Shqip": {
        ...
        "geo_labels": ["[ TË GJITHA ]", "[ MKD ]", "[ KOS ]", "[ ALB ]", "[ BALLKANI ]", "[ INT ]"],
        "lang_header": "🌐 Gjuha",
    ...
    "Македонски": {
        ...
        "geo_labels": ["[ СИТЕ ]", "[ MKD ]", "[ KOS ]", "[ ALB ]", "[ БАЛКАН ]", "[ INT ]"],
        "lang_header": "🌐 Јазик",
    ...
    "Srpski": {
        ...
        "geo_labels": ["[ SVE ]", "[ MKD ]", "[ KOS ]", "[ ALB ]", "[ BALKAN ]", "[ INT ]"],
        "lang_header": "🌐 Jezik",
...
# --- CONFIG & INJECTED PREMIUM STYLE MATRIX ---
...
<style>
    ...
    [data-testid="stSidebar"] div[role="radiogroup"] label { width: 100% !important; margin: 0 !important; padding: 6px 2px !important; justify-content: center !important; text-align: center !important; background-color: transparent !important; border-radius: 999px !important; border: 1px solid #475569 !important; cursor: pointer !important; transition: all 0.2s ease !important; }

    div[role="radiogroup"] label > div:first-child { display: none !important; }
    div[role="radiogroup"] label p { color: #64748B !important; font-weight: 700 !important; font-size: 0.78rem !important; margin: 0 !important; white-space: nowrap !important; letter-spacing: -0.02em !important; }
    ...
    .card-tag { background: #3B82F6; color: #FFFFFF; font-size: 0.65rem; font-weight: 800; padding: 4px 10px; border-radius: 6px; text-transform: uppercase; letter-spacing: 0.05em; display: inline-block; margin-bottom: 12px; }
    ...
    .source-link-card:hover { border-color: #3B82F6; background-color: rgba(59, 130, 246, 0.05); }
    
    /* PRIMARY TRIGGER OVERLAY INTERFACES */
            ...
            card_html = "".join([
                ...
                '<div class="card-footer">',
                    '<div style="display: flex; justify-content: space-between; font-size: 0.8rem; font-weight: 700; color: #475569; margin-bottom: 6px;">',
                        f'<span>🇪🇺 {t.get("pw")}: <span style="color:#0F172A;">{pw}%</span></span>',
                        f'<span>🔍 {t.get("obj")}: <span style="color:#0F172A;">{obj}%</span></span>',
                    '</div>',
...
# Elegant Injected Scroll Floater Button
